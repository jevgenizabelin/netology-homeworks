...
8. 
https://github.com/jevgenizabelin/kibana-role/tree/2.2.0

https://github.com/jevgenizabelin/filebeat-role/tree/2.1.0


## Необязательная часть

- В задани  про молекулу у меня и так подымается весь стэк и проверяется. Поэтому не стал делать дополнительное задание. Роль filebeat-role как раз связана со всеми ролями.
https://github.com/jevgenizabelin/filebeat-role/tree/2.0.0
